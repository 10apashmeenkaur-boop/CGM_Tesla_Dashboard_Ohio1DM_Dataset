...
| Library      | Purpose                                        |
|--------------|------------------------------------------------|
| React (Vite) | Framework & State Management                   |
| Recharts     | Dual-Trace Area Mapping (Actual & Predicted)   |
| Tailwind CSS | "Glory Blue" animations & Grid Layouts         |
| PapaParse    | High-speed parsing of OhioT1DM CSV datasets    |
